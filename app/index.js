...
import { View, Text, StyleSheet, Dimensions, StatusBar, TextInput } from 'react-native';
...
const {
    ...
    block, 
    cond, eq, set, 
    Clock, startClock, stopClock, debug, timing, clockRunning,
    interpolate,
    Extrapolate,
    concat
} = Animated
...
export default class VimoApp extends Component {
  constructor(props) {
    super(props);
      ...
      <View style={styles.container}>
        ...
        <Animated.View style={{...StyleSheet.absoluteFill, transform:[{translateY:this.bgY}]}}>
            <Svg height={height + 50} width={width}>
                ...
                <Image
                    href={require('../assets/images/bg1.jpg')}
